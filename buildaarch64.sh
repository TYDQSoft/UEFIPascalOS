	...
	objcopy -I pei-aarch64-little -O efi-app-aarch64 Binaries/Installer/uefiinstaller.exe Binaries/Installer/bootaa64.efi
	objcopy -I pei-aarch64-little -O efi-app-aarch64 Binaries/BootLoader/uefiloader.exe Binaries/BootLoader/bootaa64.efi
	...
	/home/tydq/source/compiler/ppca64 -n -O4 -Si -Sc -Sg -Xd -Ur -CX -Xs -Xi -Cg -k-pie -FuBaseUnits -FEBinaries/System System/kernelmain.pas
