	...
	/home/tydq/source/compiler/ppcx64 -n -O4 -Si -Sc -Sg -Xd -Ur -CX -XXs -Xi -Twin64 -Cg -FuBaseUnits -FEBinaries/Installer Installer/uefiinstaller.pas
	/home/tydq/source/compiler/ppcx64 -n -O4 -Si -Sc -Sg -Xd -Ur -CX -XXs -Xi -Twin64 -Cg -FuBaseUnits -FEBinaries/BootLoader BootLoader/uefiloader.pas
	objcopy -I pei-x86-64 -O efi-app-x86_64 Binaries/Installer/uefiinstaller.dll Binaries/Installer/bootx64.efi
	objcopy -I pei-x86-64 -O efi-app-x86_64 Binaries/BootLoader/uefiloader.dll Binaries/BootLoader/bootx64.efi
	...
	/home/tydq/source/compiler/ppcx64 -n -O4 -Si -Sc -Sg -Xd -Ur -CX -Xs -Xi -Cg -FuBaseUnits -FEBinaries/System System/kernelmain.pas
