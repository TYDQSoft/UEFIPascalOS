	...
	/home/tydq/source/compiler/ppcx64 -n -O4 -Si -Sc -Sg -Xd -Ur -CX -XXs -Xi -Cg -k-nostdlib -dCPUX86_64 -dcpux86_64 -dCPU64 -FuBaseUnits -FEBinaries/BootLoader BootLoader/uefiloader.pas
	rm -rf Utility/elf2efi
	/home/tydq/source/compiler/ppcx64 -n -O4 -Si -Sc -Sg -Xd -Ur -CX -XXs -Xi -Fu/home/tydq/source/compiler/x86_64/units/x86_64-linux -Fu/home/tydq/source/rtl/units/x86_64-linux -Cg Utility/elf2efi.pas
	rm -rf Utility/*.o Utility/*.ppu
	./Utility/elf2efi "Binaries/BootLoader/uefiloader" Custom "Binaries/BootLoader/bootx64.efi"
	rm -rf BaseUnits/*.ppu BaseUnits/*.o Installer/*.o Installer/*.ppu BootLoader/*.o BootLoader/*.ppu
	/home/tydq/source/compiler/ppcx64 -n -O4 -Si -Sc -Sg -Xd -Ur -Us -CX -XXs -Cg BaseUnits/system.pas
	/home/tydq/source/compiler/ppcx64 -n -O4 -Si -Sc -Sg -Xd -Ur -CX -XXs -Cg BaseUnits/fpintres.pas
	/home/tydq/source/compiler/ppcx64 -n -O4 -Si -Sc -Sg -Xd -Ur -CX -XXs -Cg BaseUnits/sysinit.pas
	/home/tydq/source/compiler/ppcx64 -n -O4 -Si -Sc -Sg -Xd -Ur -CX -XXs -Cg BaseUnits/si_prc.pas
	/home/tydq/source/compiler/ppcx64 -n -O4 -Si -Sc -Sg -Xd -Ur -CX -XXs -Xi -Cg -k-nostdlib -dCPUX86_64 -dcpux86_64 -FuBaseUnits -FEBinaries/System System/kernelmain.pas
	...
	mcopy -i Binaries/fat.img Binaries/BootLoader/*.efi ::/EFI/BOOT/bootx64.efi
